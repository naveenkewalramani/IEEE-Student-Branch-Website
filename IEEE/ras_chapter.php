...
<head>
	...
	<title>RAS Student Chapter - IEEE SB IIIT Allahabad</title>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main_content">
		...
		<div class="sidebar_content_box ">
			...
			<div id="accordion">
			<h2><a href="#"> IEEE Robotics & Automation Society (RAS) SB Chapter - IIITA (SBC14321A) </a></h2>
				<div>
				<h3><a href="#">Office Bearers (2016-17) </a></h3>
					<table width="100%" border="0">
						<tr>
						  <td>
						  <h4>Akash Dubey (Chairperson)<h4><br>
						  </td>
						</tr>
			          </table>
				</div>
			...
			<h3><a href="#">Office Bearers (2015-16) </a></h3>
				<div>
					<table width="100%" border="0">
						<tr>
						  <td>
							Soumyarka Mondal (Chairperson)<br>
							Shubham Gupta (Vice Chair)<br>
							Chaitanya Agarwal (Vice Chair)<br>
							Akash Dubey (Secretary)<br>
							Yanamadala Jaiprakash (Additional Secretary)<br>
							Adrish Banerjee (Treasurer)<br><br>
							
							<div><b>Other Members/Volunteers- </b></div>
							Abhishek Vijayan<br>
							Nikita Agrawal<br>
							Tanushree Anand<br>
							Aakansha Mathuria<br>
							Amrita Singh<br>
							Ishu Matil<br>
							Shubham Nanda<br>
						  </td>
