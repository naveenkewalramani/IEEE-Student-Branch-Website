...
<?php
	...
	$message = $_POST['text'];
	$message = $san->cleanString($message);
	$message = $san->cleanHtml($message);
	$message = $san->cleanJs($message);
	$c = 0;
	...
	if ($c == 1) {
		$query = "INSERT INTO contact (name, email_id, phone, subject, message) VALUES (:name, :email, :phone, :subject, :message)";
		...
		$stmt->execute();
		echo "<script> alert('Thanks, Your response has been successfully recorded.')</script>";
	}
    }
...
<title>Contact - IEEE SB IIIT Allahabad</title>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main_content">
        ...
        <div id="templatemo_content">	
	            ...
	            <div id="contact_form">
	                ...
	                <form method="post" name="contact" action="contact.php">
	                    ...
	                    <div class="col_2 no_margin_right">
	                      ...
	                      <input name="subject" type="text" class="input_field" id="subject" maxlength="50" required=""/>
	                        <div class="clear"></div>
	                    </div>
			...
			<a href = "reach.php" class = "more">Reach Us</a>
