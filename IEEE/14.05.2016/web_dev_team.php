...
<title>Web Development Team - IEEE SB IIIT Allahabad</title>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main_content">
		...
		<h3 style="text-align:center; font-weight: 900">Developers</h3>
            
		
		        <div id="thumb">
                    <a target="_blank" href = "http://theroboticistvenkat.webs.com"><img src="images/developers/venkat1.jpg" alt = "Venkat Beri" style="border-radius:50%;"><br>
                    <p>Venkat Beri</p></a>
                    <a href="mailto:pro2014002@iiita.ac.in"><p style="font-size: 110%; color: #0c0cff;">pro2014002@iiita.ac.in</p></a>
                    <p style="font-size:120%;"> Ph.D </p>
                </div>
				<div id="thumb">
                    <a target="_blank" href = http://profile.iiita.ac.in/iit2014110">
					<img src="images/professional team/amit.png" width="100" height="100" style="border-radius:50%;"/><br>
                    <p>Amit Vijay</p></a>
                    <a href="mailto:iit2014110@iiita.ac.in"><p style="font-size: 120%; color: #0c0cff;">iit2014110@iiita.ac.in</p></a>
                    <p style="font-size:120%;">B.Tech</p>
                </div>
