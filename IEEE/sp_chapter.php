...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main_content">
		...
		<div class="sidebar_content_box ">
			...
			<div id="accordion">
				<h2><a href="#"> IEEE Signal Processing (SP) Student Branch Chapter - IIITA (SBC14321C) </a></h2>
			</div>
			...
			<div id="accordion">
				<div>
					...
					<tr>
			            	<td><img src="images/professional team/sksingh.jpg" width="80" height="100" style="border-radius:50%;"/></td>
			            	<td><div><h4><b><br><a target="_blank" href = "https://sites.google.com/site/sksiiita/">Dr. Satish Kumar Singh</a></b></h4></div>
			                <div>Faculty Advisor, IEEE Signal Processing Student Chapter IIIT Allahabad<br>
						Treasurer, IEEE UP Section<br>
			                	Email: sk.singh@iiita.ac.in<br> 
						Tel: +91-532-2922533</div><br>
			            	</td>
			        	</tr>
					</table>
					
					<br><br><h3><a href="#"> Office Bearers (2016-17) </a></h3>					
					
					<table width="100%" border="0">
					<tr>
						<td><div><h4><b>Mr. Sudhakar Mishra (Chairperson)</b></h4></div><br></td>
