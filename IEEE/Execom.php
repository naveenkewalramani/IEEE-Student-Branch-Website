...
<head>
	...
	<title>Executive Committee Members - IEEE SB IIIT Allahabad</title>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main_content">
		...
		<div class="sidebar_content_box ">
			...
			<div id="accordion">
			<h2><a href="#">IEEE-SB-IIITA Executive Committee (ExCom) Members</a></h2>
			<div>
			<b>Faculty Counselor, IEEE-SB-IIITA</b><br>
			<b>Faculty Coordinator, IEEE-SB-IIITA</b><br>
			<b>All the Office Bearers,  IEEE-SB-IIITA</b><br><br>
			<b>Other members:</b><br>
				<table width="100%" border="0">
			        <tr>
                                <t>Chairperson, IEEE Robotics and Automation (RAS) SB Chapter</t><br>
				<t>Chairperson, IEEE Computer Society Student Branch Chapter</t><br>
				<t>Chairperson, IEEE Signal Processing Student Branch Chapter</t><br>
				<t>Chairperson, IEEE Women In Engineering (WIE) Affinity Group</t><br><br>
				</tr>

			           <!--  <tr> <td><img src="images/professional team/soumyarka_mondal.jpg" width="100" height="120" style=""/></td>
			              <td><div><h4><b><br><a target="_blank" href = "">Soumyarka Mondal</a></b></h4></div>
			                Role : Chairperson, IEEE Robotics and Automation (RAS) Student Branch Chapter<br>
							StMIEEE: 93235848<br>
			                Email: iit2012092@iiita.ac.in<br>
			                B.Tech Student<br><br>
			              </td>
			            </tr>
						<tr>
			              <td><img src="images/professional team/monika_rani.jpg" width="100" height="120" style=""/></td>
						  <td><div><h4><b><br><a target="_blank" href = "">Monika Rani</a></b></h4></div>
			                Role : Interim Chairperson, IEEE Women In Engineering (WIE) Student Branch Affinity Group<br>
							GSMIEEE: 92518569<br>
